        ...
        <table class="table table-striped table-dark">
            ...
            <tbody>
                ...
                while($fila=$result->fetch_assoc()){
                    ...
                    echo "<td>".$fila['Tel']."</td>";
                    echo "<td><form action='elim_empl.php' method='post'>
                    <input type='hidden' value='".$fila['id_empleado']."'name='text_2' readonly>
                    <input type='submit' value='Eliminar' name='btn_elim' class='btn btn-danger'>
                    </from></td>";
                    echo "<td><a href='edit_empl.php?no=".$fila['id_empleado']."'><button type='button' class='btn btn-info text-white'>Editar</button></a></td>";                   
                }
                mysqli_close($enlace);?>     
            </tbody>
        </table>
