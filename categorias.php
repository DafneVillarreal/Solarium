            ...
            <table class="table table-striped table-dark">
                ...
                <tbody>
                    ...
                    while($fila=$result->fetch_assoc()){
                        echo "<tr data-id=".$fila['id_categoria'].">";
                        echo "<td>".$fila['Nombre']."</td>";
                        echo "<td><form action='elim_cate.php' method='post'>
                        <input type='hidden' value='".$fila['id_categoria']."'name='text_2' readonly>
