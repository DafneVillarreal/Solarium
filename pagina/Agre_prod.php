...
<html lang="es">
    ...
    <head>
        ...
        <a role="menuitem" onclick="if(scroolSmooth(this,1000)) return false;;window.open('/#inicio','_self'); return false;" href="A_productos.php" style="float: none;" class="inc37_menucomp2_item inc37_menucomp2_selected" aria-label="Enlace a la página INICIO">SALIR</a></li><li id="li_inc37_menu_menucomp21" style=";">
        ...
        <h1>Agregar producto</h1>
                ...
                <form class="d-flex" action="" method="post">
                    <div class="col">
                        <div class="mb-3">
                            ...
                            <input type="text" name="txt_nombre" id="txt_nombre" class="text-white form-control" placeholder="Ejemplo: Panel" required>
                        </div>
                        <div class="mb-3">
                            <label for="apellido1" class="text-white form-label">Precio</label>
                            <input type="text" name="txt_apellido1" id="txt_apellido1" class="text-white form-control" placeholder="Ejemplo: 3500" required>
                        </div>
                        <div class="mb-3">
                            <label for="apellido2" class="text-white form-label">Stock</label>
                            <input type="text" name="txt_apellido2" id="txt_apellido2" class="text-white form-control" placeholder="Ejemplo: 25">
                        </div>
                        <div class="mb-3">
                            <label for="email" class="text-white form-label">Categoria</label>
                            <select type="text" name="Select_cate" id="txt_email" class="text-white form-control" placeholder="Ejemplo: Inversores" required>
                                <option value="" class="text-dark form-select" >Categoria</option>
                                <?php
                                $enlace = mysqli_connect("localhost", "root", "", "solarium");
                                $sql =$enlace->query("SELECT id_categoria,Nombre FROM categoria;");
                                while($fila=$sql->fetch_array()){
                                    echo "<option class='text-dark form-select' value='".$fila['id_categoria']."'>".$fila['Nombre']."</option>";
                                }
                                mysqli_close($enlace);
                                ?>
                            </select>
                        ...
                        <div class="mb-3">
                            <label for="tel" class="text-white form-label">Proveedor</label>
                            <select type="text" name="Select_prove" id="txt_email" class="text-white form-control" placeholder="Ejemplo: Solis" required>
                                <option value="" class="text-dark form-select" >Proveedor</option>
                                <?php
                                $enlace = mysqli_connect("localhost", "root", "", "solarium");
                                $sql =$enlace->query("SELECT id_proveedor,Nombre,Email,Pag FROM proveedor;");
                                while($fila=$sql->fetch_array()){
                                    echo "<option class='text-dark form-select' value='".$fila['id_proveedor']."'>".$fila['Nombre']."</option>";
                                }
                                mysqli_close($enlace);
                                ?>
                            </select>                    
            ...
            <?php
                if(isset($_POST["btn_enviar"])){
                    ...
                    $txt_mail = utf8_decode($_POST["Select_cate"]);
                    $txt_tel = utf8_decode($_POST["Select_prove"]);
                    $sql="INSERT INTO producto(Nombre,Precio,Stock,id_categoria,id_proveedor)VALUES('".$txt_nombre."','".$txt_ap1."','".$txt_ap2."','".$txt_mail."','".$txt_tel."');";
