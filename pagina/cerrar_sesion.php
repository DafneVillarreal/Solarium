...
<html lang="es">
    ...
    <head> 
            ...
            <?php include("template-20230830T213841Z-001/template/form_pag.php"); ?>  <style>
                #btn_no {
                    margin-left: 1000px; 
                }
            </style>
                    ...
                    <form class="d-flex" action="logout.php" method="post">
                        <div class="col">
                            <div class="contenedor">
                                <button name="action" value="si" type="submit" class="btn btn-success">Sí</button>
                                <button name="action" id="btn_no" value="no" type="submit" class="btn btn-success">No</button>
                            </div> 
                        </div>
                    </form>
                </div>
