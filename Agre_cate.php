...
<html lang="es">
    ...
    <head>
        ...
        <a role="menuitem" onclick="if(scroolSmooth(this,1000)) return false;;window.open('/#inicio','_self'); return false;" href="categorias.php" style="float: none;" class="inc37_menucomp2_item inc37_menucomp2_selected" aria-label="Enlace a la página INICIO">SALIR</a></li><li id="li_inc37_menu_menucomp21" style=";">
        ...
        <h1>Agregar categoria</h1>
            ...
            <?php
                if(isset($_POST["btn_enviar"])){
                    ...
                    $sql="INSERT INTO categoria(Nombre)VALUES('".$txt_nombre."');";
